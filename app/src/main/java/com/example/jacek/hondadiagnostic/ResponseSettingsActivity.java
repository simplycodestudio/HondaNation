...
public class ResponseSettingsActivity extends AppCompatActivity
{
    ...
    private StorageReference storeProfilImagestorageRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_response_settings);
        ...
        storeProfilImagestorageRef = FirebaseStorage.getInstance().getReference().child("Profile_Images");
        ...
        settingsDisplayName = (TextView) findViewById(R.id.Response_settings_username);
        settingsDisplayStatus = (TextView) findViewById(R.id.Response_settings_user_status);
        settingsChangeProfileImageButton = (Button) findViewById(R.id.Response_settings_change_profile_image_button);
        settingsChangeStatusButton = (Button) findViewById(R.id.Response_settings_change_profile_status);
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
              ...
              {
//                  Picasso.with(ResponseSettingsActivity.this).load(image).placeholder(R.drawable.default_profile).into(settingsDisplayProfileImage);
                  Picasso.with(ResponseSettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
        ...
        settingsChangeStatusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
              ...
              Intent statusIntent = new Intent(ResponseSettingsActivity.this, ResponseStatusActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                StorageReference filePath = storeProfilImagestorageRef.child(user_id + ".jpg");
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task)
                    {
                     ...
                     {
                         Toast.makeText(ResponseSettingsActivity.this,
                         ...
                         {
                         Toast.makeText(ResponseSettingsActivity.this, "Error occured, while uploading pic.", Toast.LENGTH_SHORT).show();
