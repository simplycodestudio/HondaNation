...
import adapters.NaprawyListAdapter;
import entities.Naprawy;
import com.example.jacek.hondadiagnostic.database.*;
...
//implements PopupMenu.OnMenuItemClickListener, GoogleApiClient.OnConnectionFailedListener
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            Intent intent1 = new Intent(Dziennik_napraw.this, Menu_glowne.class);
